...
| :--- | :--- | :--- | :--- |
| OC-0106 | **Realtime Voice Interface** | STT (Whisper) + LLM + TTS pipeline with low-latency optimization | ✅ Done |
| OC-0107 | **Live Translator** | Listen to an audio stream and output translated text or audio in real time | ✅ Done |
| OC-0108 | **Voice Sentiment Analyzer** | Detect emotion and stress levels in audio input | ✅ Done |
| OC-0109 | **Active Listener** | Detect pauses and interruptions to manage turn-taking naturally | ✅ Done |
| OC-0110 | **Meeting Scribe (Realtime)** | Live transcription and action item extraction during calls | ✅ Done |
| OC-0111 | **Voice Biometrics** | Identify speakers by voice print for personalization | ✅ Done |
| OC-0112 | **Audio Noise Reducer** | Clean up microphone input in software in real time | ✅ Done |
| OC-0113 | **Podcast Summarizer** | Fetch, transcribe, and summarize podcast episodes on demand | ✅ Done |
| OC-0114 | **Call Quality Monitor** | Detect jitter, latency, and packet loss in VoIP streams | ✅ Done |
...
| ID | Skill | Description | Status |
| :--- | :--- | :--- | :--- |
| OC-0115 | **Prompt Version Control** | Save, tag, and rollback prompt templates (git-backed) | ✅ Done |
| OC-0116 | **Token Cost Estimator** | Calculate input/output tokens and cost before running a prompt | ✅ Done |
| OC-0117 | **Context Compressor** | Summarize or truncate conversation history to fit context windows | ✅ Done |
| OC-0118 | **RAG Manager** | Handle document chunking, embedding, and storage logic | ✅ Done |
| OC-0119 | **Model Benchmarker** | Run the same prompt against GPT-4, Claude, and Llama to compare output | ✅ Done |
| OC-0120 | **Bias & Safety Checker** | Pre-screen outputs for sensitive or harmful content | ✅ Done |
| OC-0121 | **System Prompt Optimizer** | Meta-prompting to iteratively improve the agent's own instructions | ✅ Done |
| OC-0122 | **Knowledge Graph Builder** | Extract entities and relationships from chat to build long-term memory | ✅ Done |
| OC-0123 | **Tool Use Validator** | Ensure JSON arguments generated by LLMs match the expected schema | ✅ Done |
| OC-0124 | **Agent Chain Debugger** | Visualize and replay multi-step agent tool call chains | ✅ Done |
| OC-0125 | **Embedding Drift Detector** | Alert when retrieved context chunks diverge significantly from the query | ✅ Done |
| OC-0126 | **Eval Suite Runner** | Run automated evals against a golden dataset to catch regressions | ✅ Done |
...
| ID | Skill | Description | Status |
| :--- | :--- | :--- | :--- |
| OC-0127 | **Linear Issue Manager** | Create, update, and triage issues and cycles | ✅ Done |
| OC-0128 | **Jira Ticket Handler** | Manage sprints, epics, and story point estimation | ✅ Done |
| OC-0129 | **Todoist Task Sync** | Add, complete, and prioritize tasks across projects | ✅ Done |
| OC-0130 | **Notion Task Manager** | Create, update, and filter database rows in Notion | ✅ Done |
| OC-0131 | **Google Tasks Integrator** | Sync tasks with Google Workspace | ✅ Done |
| OC-0132 | **ClickUp Workspace Manager** | Manage tasks, docs, and goals in ClickUp | ✅ Done |
...
| ID | Skill | Description | Status |
| :--- | :--- | :--- | :--- |
| OC-0150 | **Web Research Agent** | Search, scrape, and synthesize information from multiple sources | ✅ Done |
